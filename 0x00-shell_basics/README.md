...
2-bring_me_homescript that changes the working directory to the user’s home directory.
...
10-back script that changes the working directory to the previousone.
